...
<body>
    <div class="no-print">
        <span class="text-header">Daftar Staff</span>
        <div class="btn-no-print">
            <a href="<?= BASEURL; ?>/TablePetugas/index">
    ...
    <div class="container">
        ...
        <div class="document-title">Daftar Staff</div>
        ...
        <table>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?= $number ?></td>
                        <td><?= $petugas['full_name'] ?></td>
                        <td><?= $petugas['username'] ?></td>
                        <td>PTG-<?= $petugas['user_id'] ?></td>
                        <td><?= $petugas['family_card_number'] ?></td>
                        <td><?= $petugas['email'] ?></td>
