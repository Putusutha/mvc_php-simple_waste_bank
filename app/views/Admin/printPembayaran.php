...
<body>
    <div class="no-print">
        <span class="text-header">Daftar Pembayaran</span>
        <div class="btn-no-print">
            <a href="<?= BASEURL; ?>/TablePembayaran/index">
    ...
    <div class="container">
        ...
        <div class="document-title">Daftar Pembayaran</div>
        ...
        <table>
            ...
            <tbody>
                <?php
                $number = 1;
                foreach ($data['pembayaran'] as $trans) :
                ?>
                    <tr>
                        <td><?= $number ?></td>
                        <td>INV/TPS3R-<?= $trans['transaction_id'] ?></td>
                        <td>DLV/TPS3R-<?= $trans['pickup_id'] ?></td>
                        <td><?= $trans['username'] ?></td>
                        <td><?= $trans['pickup_finished'] ?></td>
